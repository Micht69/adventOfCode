...
public class Exo09 {
	...
	public void example1_4() {
		int ret = program1("{<a>,<a>,<a>,<a>}");
		Assert.assertEquals(1, ret);
	}

	@Test
	public void example1_5() {
		int ret = program1("{{<ab>},{<ab>},{<ab>},{<ab>}}");
	...
	public void example2_2() {
		int ret = program2("<random characters>");
	...
	@Test
	public void example2_6() {
		int ret = program2("<!!!>>");
		Assert.assertEquals(0, ret);
	}

	@Test
	public void example2_7() {
		int ret = program2("<{o\"i!a,<{i<a>");
