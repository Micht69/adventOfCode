...
public class Exo04 {
	...
	public void example1_1() {
		int ret = program1("aa bb cc dd ee");
		Assert.assertEquals(1, ret);
	}

	@Test
	public void example1_2() {
		int ret = program1("aa bb cc dd ee", "aa bb cc dd aa");
		Assert.assertEquals(1, ret);
	}

	@Test
	public void example1_3() {
		int ret = program1("aa bb cc dd ee", "aa bb cc dd aa", "aa bb cc dd aaa");
	...
	public void example2_1() {
		int ret = program2("abcde fghij");
		Assert.assertEquals(1, ret);
	}

	@Test
	public void example2_2() {
		int ret = program2("abcde fghij", "abcde xyz ecdab");
		Assert.assertEquals(1, ret);
	}

	@Test
	public void example2_3() {
		int ret = program2("abcde fghij", "abcde xyz ecdab", "a ab abc abd abf abj");
		Assert.assertEquals(2, ret);
	}

	@Test
	public void example2_4() {
		int ret = program2("abcde fghij", "abcde xyz ecdab", "a ab abc abd abf abj", "iiii oiii ooii oooi oooo");
		Assert.assertEquals(3, ret);
	}

	@Test
	public void example2_5() {
		int ret = program2("abcde fghij", "abcde xyz ecdab", "a ab abc abd abf abj", "iiii oiii ooii oooi oooo", "oiii ioii iioi iiio");
		Assert.assertEquals(3, ret);
	}
